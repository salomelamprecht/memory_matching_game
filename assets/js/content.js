...
function intro() { 
  ...
  let playInstructionsDiv = document.createElement('div');
    playInstructionsDiv.setAttribute('class', 'container text-center play-instructions');
  ...
  let instructionTxt = document.createElement('p');
    instructionTxt.textContent = 'Your timer has started Pick 2 cards. If your 2 cards match, pick another 2 cards! Continue selecting cards until you have matched them all! Have FUN!';
